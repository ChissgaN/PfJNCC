...
<head>
    ...
    <!-- Style Sheet CSS-->
    <link rel="stylesheet" href="../assets/alumnosdashboardStyles.css">
...
<body style="background-color: whitesmoke;">
    ...
    <div class="inside" >
        ...
        <div class="insideTwoContainer">
            <div class="insideTwo" >
                <a href="../Views/alumno_dashboard.php" class="hoDa">Home </a>
    ...
    <div class="p-3 rectangle" >
        <h6>Bienvenido</h6>
        <p>Pronto se le asignaran las Materias correspondientes</p>
    </div>
    ...
    <div class="sidebar">
        ...
        <div class=" mt-3   admin" >
            <h5 class="ms-3 mb-2 textAdmin" >Alumno</h5>
            <p class="ms-3 mb-2 textAdmin" >alumno</p>
        </div>
            <ul class="mt-4 options" > MENU ADMINISTRACIÓN
            
                <li class="mt-4">
                    <a class="optionsA" href="">Clases
