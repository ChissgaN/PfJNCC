...
$usuarioID = $_SESSION['userData']['id'];

$query = "SELECT usuarios.id AS usuario_id, usuarios.name AS usuario_name, materias.id AS materia_id, materias.materia
FROM usuarios
LEFT JOIN materias ON usuarios.materias_id = materias.id
WHERE usuarios.id = $usuarioID AND (usuarios.materias_id IS NULL OR usuarios.materias_id = materias.id)";
...
<head>
    ...
    <!-- Style Sheet CSS-->
    <link rel="stylesheet" href="../assets/maestrosclasesStyles.css">
        ...
        <table id="miTabla" class=" ms-3 me-4 mt-3 tableP">
            ...
            <tbody class="bodyTable" >
                <?php foreach ($data as $materia): ?>
                    <tr class="fileBody">
                        <td class="ps-3 idP"><?php echo $materia['materia_id']; ?></td>
                        <td class="ps-3 claseP"><?php echo $materia['materia']; ?></td>
                        <td class="ps-3 maestrosP"><?php echo $materia['usuario_name']; ?></td>
                        <td class="ps-3 alumnosP">Por Asignar</td>
...
<div class="sidebar">
    ...
    <script src="../Scripts/togglemaestroclases.js" ></script>
</body>
</html>